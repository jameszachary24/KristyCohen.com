  ...
  const features = [
    {
      ...
      description: 'Scale your business with systems that work 24/7'
    },
    {
      icon: FiUsers,
      title: 'More Qualified Leads',
      description: 'Attract and convert your ideal customers'
    },
    {
      icon: FiTarget,
      title: 'Higher Conversions',
      description: 'Turn visitors into paying customers consistently'
    }
  ];
